...
@Service
public class ClubManagementAgentService extends BaseAgentService {

    public ClubManagementAgentService(@Qualifier("clubManagementClient") ChatClient chatClient,
    ...
    public AgentType getAgentType() {
        return AgentType.CLUB_MANAGEMENT;
    }
}
