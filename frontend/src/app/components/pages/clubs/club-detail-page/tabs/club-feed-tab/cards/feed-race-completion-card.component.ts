...
@Component({
  ...
  styles: `
    ...
    .trophy-icon { color: var(--dev-accent-color); flex-shrink: 0; }
    ...
    .finish-time { font-size: 10px; font-weight: 600; color: var(--success-color); font-family: monospace; }
    ...
    .kudos-given { display: flex; align-items: center; justify-content: center; gap: 6px; width: 100%; padding: 8px; font-size: var(--text-xs); font-weight: 600; color: var(--success-color); }
