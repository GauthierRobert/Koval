 ...
 * </ul>
 *
 * <p>This mirrors the Polar integration controller. Activity sync and workout push are
 * not implemented yet — they'll be added incrementally once the OAuth bootstrap lands.
 */
@RestController
