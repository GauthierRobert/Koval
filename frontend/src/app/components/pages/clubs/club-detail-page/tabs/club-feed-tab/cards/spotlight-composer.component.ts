  ...
  template: `
    <div class="composer-card" data-testid="spotlight-composer">
      ...
      <div class="composer-row">
        ...
        <select
          data-testid="spotlight-member-select"
          class="composer-input"
          [(ngModel)]="spotlightedUserId"
        >
      ...
      <div class="composer-row">
        ...
        <input
          data-testid="spotlight-title-input"
          class="composer-input"
      ...
      <div class="composer-actions">
        <button class="composer-cancel" (click)="cancelled.emit()">
          {{ 'COMMON.CANCEL' | translate }}
        </button>
        <button
          data-testid="spotlight-publish-btn"
          class="btn-primary"
          [disabled]="!canSubmit"
          (click)="onSubmit()"
        >
