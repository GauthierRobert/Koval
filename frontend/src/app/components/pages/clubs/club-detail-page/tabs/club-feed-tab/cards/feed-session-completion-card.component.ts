...
@Component({
  ...
  template: `
    <div
      ...
      class="feed-card feed-card--pinned"
      [class.feed-card--expanded]="expanded"
    >
      <div class="card-pin-badge">{{ 'CLUB_FEED.PINNED' | translate }}</div>
      <div class="card-header">
        <app-sport-icon [sport]="$any(event.sessionSport ?? 'CYCLING')" [size]="20" />
        ...
        <div class="completion-actions">
          @if (!hasGivenKudos) {
            ...
            >
              ...
              <svg class="strava-logo" viewBox="0 0 24 24" width="14" height="14" fill="white">
                <path
