...
public class TrainingToolService {
    ...
    public TrainingToolService(TrainingManagementService trainingManagementService) {
    ...
    public TrainingSummary createTraining(
            @ToolParam(description = "The training object to create") Training training,
    ...
    public TrainingSummary updateTraining(
            ...
            @ToolParam(description = "The training fields to update") Training updates) {
        return TrainingSummary.from(trainingManagementService.updateTraining(trainingId, updates));
    }
